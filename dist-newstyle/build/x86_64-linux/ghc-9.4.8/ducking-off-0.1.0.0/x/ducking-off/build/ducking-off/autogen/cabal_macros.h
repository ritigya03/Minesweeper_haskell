...
/* package ducking-off-0.1.0.0 */
#ifndef VERSION_ducking_off
#define VERSION_ducking_off "0.1.0.0"
#endif /* VERSION_ducking_off */
#ifndef MIN_VERSION_ducking_off
#define MIN_VERSION_ducking_off(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ducking_off */
...
#define CURRENT_COMPONENT_ID "ducking-off-0.1.0.0-inplace-ducking-off"
